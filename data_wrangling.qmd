...
df_clean <- 
  df_clean |>
  mutate (
    hfa_z_score_who = as.numeric(hfa_z_score_who),
    stunting = case_when(
...
df_clean <- 
  df_clean |>
  mutate (
    bmi_who = as.numeric(bmi_who),
    bmi_z_score_who = as.numeric(bmi_z_score_who),
    wfa_z_score_who = as.numeric(wfa_z_score_who),
    wfh_z_score_who = as.numeric( wfh_z_score_who)
  )
```
