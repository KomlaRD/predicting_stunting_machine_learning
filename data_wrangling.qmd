...
# Load dataset for MICS4 (2011)
df_two <- read.spss("data/ch_2011.sav", to.data.frame = TRUE) 

# Load dataset for MICS3 (2006)
df_three <- read.spss("data/ch_2006.sav", to.data.frame = TRUE) 
```
...
df_clean <- df_clean %>%
  filter(str_trim(as.character(hfa_z_score_who, bmi_who, wfa_z_score_who, wfh_z_score_who, bmi_z_score_who)) != "")
```
